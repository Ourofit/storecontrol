											...
											<div className="col-md-6 p-3">
												<div className="container-fluid">
													<div className="row">
														...
														<div className="col-8 d-flex align-items-center">
															<Inputbox type="text" name="Provincia" placeholder="Provincia" />
														</div>
                                                        <div className="col-4 d-flex align-items-center">
															<span>País</span>
														</div>
														<div className="col-8 d-flex align-items-center">
                                                        <div><Dropdown name='Sales Acti' dropvalues={['Dayly', 'Monthly', 'Yearly']} value_select={sorting} onChange={sortingval}/></div>
														</div>
													</div>
												</div>
											</div>
