                                        ...
                                        <div className="container-fluid">
                                            <div className="row">
                                               ...
                                               <div >
                                                ...
                                                <div >
                                                    <Dropdown name='Provincia' onChange={settingval} dropvalues={Province?.provincias?.map((item) => item.nombre)} value_select={props.values.Pais} touched={props.touched.Provincia} errors={props.errors.Provincia} />
                                                </div> 
