...
function Sidebar(props) {
	...
	const [nav, setNav] = useState(JSON.parse(localStorage.getItem('DepositoLogin')).Type === 'Master Manager' ? navigation navigation_data.filter(ele => ele.title !== 'Tienda'))
	...
	useEffect(() => {
		console.log(localStorage.getItem('DepositoLogin'))
		var navigation = navigation_data.filter(ele => ele.title !== 'Tienda')
		setNav(navigation)
