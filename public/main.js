...
app.whenReady().then(async () => {
    ...
    //         // if (users.length !== 0) {
    //         //     await axios
    //         //         .get("https://storecontrolserver-production-3675.up.railway.app/users")
    //         //         .then((online_users) => {
    ...
    //         //                 if (flag === 0) {
    //         //                     await axios.post(
    //         //                         "https://storecontrolserver-production-3675.up.railway.app/users",
    //         //                         {
    //         //                             name: user.name,
    //         //                             email: user.email,
    //         //                         }
    ...
    //         // }
    //         // await axios
    //         //     .get("https://storecontrolserver-production-3675.up.railway.app/posts")
    //         //     .then((online_post) =>
    //         //         fs.writeFileSync(
    //         //             post_name,
