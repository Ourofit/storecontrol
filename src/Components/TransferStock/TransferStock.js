    ...
    const onSubmit = async (values, { resetForm }) => {
        ...
        if(transferir_show) {
            ...
            if(product_one === undefined) {
                ...
                if(Status) {
                    await axios.post("https://storecontrolserver-production-3675.up.railway.app/product/new", {
                            ...inti,
        ...
        if(Status) {
            await axios.put('https://storecontrolserver-production-3675.up.railway.app/product/edit', edit_val)
            await axios.put('https://storecontrolserver-production-3675.up.railway.app/product/edit', main_pro)
        }
        // await axios.get("https://storecontrolserver-production-3675.up.railway.app/product").then((item) => {
