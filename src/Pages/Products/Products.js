...
function Products(props) {
    ...
    const remove = async (i) => {
        ...
        if (Status) {
            await axios.delete(
                `https://storecontrolserver-production-3675.up.railway.app/product/delete/${i}`
            );
        } else {
            if (window.desktop) {
        ...
        if (e.key === "Enter") {
            ...
            if (e.target.name === "pdes") {
                if (pdes !== "Required") {
                    ...
                    if (Status) {
                        await axios.put("https://storecontrolserver-production-3675.up.railway.app/product/edit", db_val);
                    }
    ...
    //         //                                 await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/orderproduct/delete/${ret.val}`)
    //         //                                 .then(async item => {
    ...
    //         //                         if (flag === 0) {
    //         //                             await axios.delete(
    //         //                                 `https://storecontrolserver-production-3675.up.railway.app/product/delete/${alldata[h].Product_id}`
    //         //                             );
    //         //                             await axios.get("https://storecontrolserver-production-3675.up.railway.app/product").then(async (item) => {
