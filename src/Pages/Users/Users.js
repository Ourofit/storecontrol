...
function Users(props) {
    ...
    useEffect(() => {
            ...
            window.api.getAllData("Clients_Returns").then(async (client_ret) => {
                if (client_ret.Expenses_Returns) {
                    client_ret.Expenses_Returns.forEach(async (ret) => {
                        await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/register/delete/${ret.id}`).then(async dele => {
                            await axios.get("https://storecontrolserver-production-3675.up.railway.app/register").then(async (item7) => {
        ...
        /*      axios.delete(`https://storecontrolserver-production-3675.up.railway.app/register/delete/${id}`).then( dele => {
    ...
    const removeClient = async (id) => {
        if (Status) {
            await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/register/delete/${id}`);
